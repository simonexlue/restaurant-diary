...
export default function RecentEntryCard(
    ...
    return (
        <div className="flex flex-row gap-4 hover:cursor-pointer hover:bg-[rgb(248,245,242)] px-3 py-4 w-[95%] rounded-lg">
            {photoUrl ? (
            ...
            <div className="flex flex-col gap-2 flex-1 min-w-0">
                ...
                <div className="flex flex-col">
                    <div className="flex flex-row justify-between">
                        ...
                        <FiArrowRight className="text-[rgb(137,122,114)]" />
                    </div>

                    <p className="text-sm text-stone-800">{dishName}</p>
                    <div className="flex flex-col gap-2 mt-2">
                        {review && (
                            <p className="text-sm text-[rgb(137,122,114)]">{review}</p>
                        )}
                        <div className="flex flex-row gap-1 items-center">
                            <IoLocationOutline className="text-[rgb(137,122,114)]" />
                            <p className="text-sm text-[rgb(137,122,114)]">{location}</p>
                        </div>
                    </div>
                </div>
            </div>
